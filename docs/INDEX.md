...
| [`prospective_evidence/etf_publication_calendar_authority_v1_r1/`](../prospective_evidence/etf_publication_calendar_authority_v1_r1/) | Corrected hash-bound `ETF_PUBLICATION_CALENDAR_AUTHORITY_V1` source-derived definition and material child contracts | Frozen pre-data correction awaiting repeat independent exact-hash xHigh review; the failed predecessor remains immutable and non-authoritative; authorizes no V2 correction or collection |
