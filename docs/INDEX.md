...
| [`prospective_evidence/trusted_acquisition_persistence_authority_v1/`](../prospective_evidence/trusted_acquisition_persistence_authority_v1/) | Hash-bound `TRUSTED_ACQUISITION_PERSISTENCE_AUTHORITY_V1` signature, key, replay, and PostgreSQL append boundary | Frozen pre-data authority awaiting independent exact-hash xHigh review; closes the architecture decision only and does not certify the ETF calendar authority or authorize collection |
