...
| [`prospective_evidence/etf_calendar_store_capability_normal_form_v1_r1/`](../prospective_evidence/etf_calendar_store_capability_normal_form_v1_r1/) | Narrow corrected hash-bound `ETF_CALENDAR_STORE_CAPABILITY_NORMAL_FORM_V1` direct immutable-parameter proof architecture | Frozen pre-data candidate at `7ef114fe...8d17b` awaiting independent exact-hash final xHigh review; permits only ordinary explicitly annotated immutable store parameters, rejects aliases, variadics, starred forwarding, same-scope rebinding and nested annotated owners, and authorizes no calendar implementation, V2 correction, or collection |
