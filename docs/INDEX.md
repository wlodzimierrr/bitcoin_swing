...
| [`prospective_evidence/etf_calendar_in_process_authority_boundary_v1_r1/`](../prospective_evidence/etf_calendar_in_process_authority_boundary_v1_r1/) | Corrected hash-bound `ETF_CALENDAR_IN_PROCESS_AUTHORITY_BOUNDARY_V1` project-owned bypass architecture | Frozen pre-data corrected boundary at `a7d2b087...534dd0`; awaits independent exact-hash xHigh architecture re-review and authorizes no calendar implementation, V2 correction, or collection |
