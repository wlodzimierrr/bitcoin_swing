...
| [`prospective_evidence/etf_calendar_in_process_authority_boundary_v1/`](../prospective_evidence/etf_calendar_in_process_authority_boundary_v1/) | Hash-bound `ETF_CALENDAR_IN_PROCESS_AUTHORITY_BOUNDARY_V1` architecture decision | Frozen pre-data trusted-process scientific-authority boundary at `0c237c1b...887b55d`; awaits independent xHigh architecture review and authorizes no calendar implementation, V2 correction, or collection |
